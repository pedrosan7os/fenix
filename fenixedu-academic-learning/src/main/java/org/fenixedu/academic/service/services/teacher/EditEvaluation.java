...
public class EditEvaluation {
    ...
    protected Boolean run(final Course executionCourse, final MultiLanguageString evaluationMethod) {
    ...
    @Atomic
    public static Boolean runEditEvaluation(Course executionCourse, MultiLanguageString evaluationMethod)
